"use strict";var _a,_b;Object.defineProperty(exports,"__esModule",{value:!0}),exports.DefaultTokenResolver=exports.StringConcat=void 0;const jsiiDeprecationWarnings=require("../../.warnings.jsii.js"),JSII_RTTI_SYMBOL_1=Symbol.for("jsii.rtti"),encoding_1=require("./private/encoding"),token_map_1=require("./private/token-map");class StringConcat{join(left,right){return left===void 0?right!==void 0?`${right}`:void 0:right===void 0?`${left}`:`${left}${right}`}}exports.StringConcat=StringConcat,_a=JSII_RTTI_SYMBOL_1,StringConcat[_a]={fqn:"aws-cdk-lib.StringConcat",version:"2.27.0"};class DefaultTokenResolver{constructor(concat){this.concat=concat;try{jsiiDeprecationWarnings.aws_cdk_lib_IFragmentConcatenator(concat)}catch(error){throw process.env.JSII_DEBUG!=="1"&&error.name==="DeprecationError"&&Error.captureStackTrace(error,this.constructor),error}}resolveToken(t,context,postProcessor){try{jsiiDeprecationWarnings.aws_cdk_lib_IResolvable(t),jsiiDeprecationWarnings.aws_cdk_lib_IResolveContext(context),jsiiDeprecationWarnings.aws_cdk_lib_IPostProcessor(postProcessor)}catch(error){throw process.env.JSII_DEBUG!=="1"&&error.name==="DeprecationError"&&Error.captureStackTrace(error,this.resolveToken),error}try{let resolved=t.resolve(context);return resolved=context.resolve(resolved),resolved=postProcessor.postProcess(resolved,context),resolved}catch(e){let message=`Resolution error: ${e.message}.`;throw t.creationStack&&t.creationStack.length>0&&(message+=`
